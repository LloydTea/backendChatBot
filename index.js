  ...
  try {
    const response = await openai.createChatCompletion({
      ...
      messages: [
        {
          role: "system",
          content: `You're a helpful assistant, You are to review users input, ask important questions that will help you determine if the user has a valid personal injury and is owed a compensation for injury incured. And finaly generate a report similar to ${reportModel}. Also add casually section of the law that supports the report you're generating`,
        },
        ...conversationHistory,
      ],
    });
